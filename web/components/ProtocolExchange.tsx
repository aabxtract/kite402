export function ProtocolExchange() {
  return (
    <div
      ...
      className="rounded-xl border border-line bg-surface font-mono text-[13px] leading-relaxed"
    >
      ...
      <div className="space-y-4 px-4 py-4">
        <div>
          <p className="text-dim">
            <span className="text-ink">GET</span> /p/wx7Kd91k2A
          </p>
          <p className="mt-1 font-semibold text-ink">402 Payment Required</p>
        ...
        <div className="border-l-2 border-line pl-3 text-dim">
          ...
          <p className="text-ink/60">payer signs · facilitator settles on-chain</p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-mint font-semibold">200 OK</p>
          <p className="text-dim">
